...
Source path: `src/ndae/evaluation/__init__.py`

## Role

This file belongs to the `src/ndae/evaluation` slice of the NDAE repository. Public evaluation API for NDAE. Its main job is to define the import surface for the surrounding package.
