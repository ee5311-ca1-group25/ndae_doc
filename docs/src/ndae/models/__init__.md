...
Source path: `src/ndae/models/__init__.py`

## Role

This file belongs to the `src/ndae/models` slice of the NDAE repository. Public model API for NDAE. Its main job is to define the import surface for the surrounding package.
